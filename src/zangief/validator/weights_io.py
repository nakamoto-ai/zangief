...
def ensure_weights_file(zangief_dir_name: str, weights_file_name: str):
...
def write_weight_file(weights_file: str, modules_info: Dict[int, Dict[str, Ss58Address | float]]):
    """
...
def read_weight_file(weights_file: str) -> Dict[int, Dict[str, Ss58Address | float]]:
    """
